...
public class SQL1 {
	...
	public SQL1(int salesOrProduction, int productId, int years, int fromYear, int toYear, String incExCountries, String incExProducts
	      ...
	      query = " select a.year, a.quantity, substr(b.name,1,20) as company, upper(d.name) as product, c.shortname as country from Facts_"+access+" a, Company b, Country c, Product d " +
